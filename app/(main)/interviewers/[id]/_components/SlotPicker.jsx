  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* ── Main picker card ── */}
        <div className="bg-[#0f0f11] border border-white/10 rounded-2xl flex flex-col gap-6 p-7">
          {/* Header */}
          ...
          {/* Date tabs */}
          <div className="flex gap-2 pb-0.5 scrollbar-none -mx-1 px-1 overflow-x-auto">
            {dates.map((date) => {
