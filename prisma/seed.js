...
// ── CHANGE THIS ───────────────────────────────────────────────────────────────
const BOOKING_ID = "c81b4bd5-f22c-48fe-98e1-ba37ebe31f1a";
// ─────────────────────────────────────────────────────────────────────────────

const feedback = {
  summary:
    "Yagnesh demonstrated a solid understanding of React fundamentals and component architecture. He approached problems methodically and showed good instincts around state management. With some refinement in system design and async patterns, he's well on track for a mid-level frontend role.",
  technical:
  ...
  sessionRating: 4,
  sessionComment:
    "Great session — Yagnesh was engaged and receptive to feedback. Would be happy to interview him again after he's done more system design prep.",
};
